...
{
header("Location: diet_afterlunch.php");
exit();
}
...
$testResult = mysqli_query($link,"SELECT * FROM todays_lunch WHERE user_id = $userid") or die('Error, query failed');
$here=$result1['item_id'];
if(mysqli_fetch_array($testResult) == NULL){
$querytobreakfast=mysqli_query($link,"INSERT INTO todays_lunch (user_id,salad_id,meal_status) VALUES('$userid','$here','1') ON DUPLICATE KEY UPDATE salad_id=$here,meal_status='1'")or die("Error: ".mysqli_error($link));
}
else{
$querytobreakfast=mysqli_query($link,"UPDATE todays_lunch  SET salad_id=$here,meal_status='1' WHERE user_id=$userid")or die("Error: ".mysqli_error($link));
}
...
if(mysqli_fetch_array($testResult) == NULL)
{
$querytobreakfast=mysqli_query($link,"INSERT INTO todays_lunch (user_id,meal1_id,meal_status) VALUES('$userid','$hereid','1') ON DUPLICATE KEY UPDATE meal1_id=$hereid, meal_status='1'")or die("Error: ".mysqli_error($link));
}
else
{
$querytobreakfast=mysqli_query($link,"UPDATE todays_lunch  SET meal1_id=$hereid,meal_status='1' WHERE user_id=$userid")or die("Error: ".mysqli_error($link));
}
}
else
...
if(mysqli_fetch_array($testResult) == NULL)
{
$querytobreakfast=mysqli_query($link,"INSERT INTO todays_lunch (user_id,meal2_id,meal_status) VALUES('$userid','$hereid','1') ON DUPLICATE KEY UPDATE meal2_id=$hereid,meal_status='1'")or die("Error: ".mysqli_error($link));
}
else
{
$querytobreakfast=mysqli_query($link,"UPDATE todays_lunch  SET meal2_id=$hereid,meal_status='1' WHERE user_id=$userid")or die("Error: ".mysqli_error($link));
}
}
                  ...
                  <div class="box-header with-border">
                    ...
                    <form method="post" align="center" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
                      ...
                      <div align="pull-right">
                        <input type="submit" name="submit" value="Track meal"  style="height:50px;width:200px" class="btn btn-primary">
                      </div>
                    </form>
                    <br>
                  </div>
