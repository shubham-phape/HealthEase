...
//insert query
$result = $mysqli->query("INSERT INTO assistant_details(aid, id, fname, lname, dob, qualification, yoe) VALUES ('',$id,'$fname','$lname','$dob','$qualification',$yoe)");
          ...
          <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="prediction.html"><i class="fa fa-circle-o"></i> Prediction</a></li>
                <li><a href="#"><i class="fa fa-circle-o"></i> Patient Report</a></li>
              </ul>
            </li>
            <li>
              <a href="Stage_calculation.html">
          ...
          <div class="row">
            <div class="col-md-6 col col-md-offset-3">
              <div class="box box-primary">
                ...
                <form role="form" action="Assistant_details.php" method="post">
                  <div class="box-body">
