...
<html>
  <head>
    ...
    <title>Reports | HealthEase</title>
  ...
  <body class="hold-transition skin-blue sidebar-mini">
    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            <!-- <li><a href="Doctor_dashboard.html"><i class="fa fa-dashboard"></i> Home</a></li> -->
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      echo '<tr>
                        ...
                        <td>'.$gender.'</td>
                        <td>'.$status.'</td>
                        <td><button class="btn btn-default report" id="view" value='.$object->pid.' data-toggle="modal" data-target="#modal-default">View</button></td>
                      </tr>';
                      }
                      }
                      else {
                        ...
                        <div class="modal-dialog">
                          <div class="modal-content">
                            ...
                            <div class="modal-footer">
                              ...
                              <button type="button" class="btn btn-primary" id="appointment">Make Appointment</button>
                            </div>
                          </div>
                          <!-- /.modal-content -->
                        </div>
    ...
    <script type="text/javascript">
      document.getElementById("appointment").onclick = function () {
        location.href = "Make_Appoinment_Doctor.php";
      };
    </script>
  </body>
</html>